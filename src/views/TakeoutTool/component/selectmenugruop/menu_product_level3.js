...
export class Menu_product_level3 extends Component {
    constructor(props) {
        super(props);
        this.state = {
            loading: true,
    ...
    async _fetchData() {
        let menu_name_select_munu2 = this.props.menu_name_select_munu2;

        const childent_menu_2 = await productmenu_model.getProductMenuBy({ product_menu_name_ref: menu_name_select_munu2 })

        this.setState({
            childent_menu_2: childent_menu_2.data,
            menu_name_select_munu2: menu_name_select_munu2,
        }
            ,
            () =>
    ...
    _push_tag_null() {
        let { childent_menu_2 } = this.state
        let length_menu = childent_menu_2.length
            ...
            <Card>
                <CardHeader>
                    <Row>
                        ...
                        <Col style={{ textAlign: "center" }}>
                            {" "}
                            <h1>{this.state.menu_name_select_munu2}</h1>
                        </Col>
                ...
                <CardBody style={{ height: "auto", margin: "20px" }}>
                    ...
                    >
                        ...
                        {this.state.childent_menu_2.map((item, idx) => (
                            ...
                            >
                                ...
                                <Link
                                    ...
                                    onClick={
                                        () => this.props._on_select_menu_3(item.product_menu_name)
                                    }
                                >
                                    <Row>
...
export default Menu_product_level3;
