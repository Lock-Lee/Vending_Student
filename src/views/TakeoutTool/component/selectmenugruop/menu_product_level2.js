...
export class Menu_product_level2 extends Component {
    constructor(props) {
        super(props);
        this.state = {
            loading: true,
    ...
    async _fetchData() {
        let menu_name_select = this.props.menu_name_select;
        // console.log("menu_name_select", menu_name_select);

        const childent_menu_1 = await productmenu_model.getProductMenuBy({ product_menu_name_ref: menu_name_select })
    ...
    _push_tag_null() {
        let { childent_menu_1 } = this.state
        let length_menu = childent_menu_1.length
            ...
            <Card>
                <CardHeader>
                    <Row>
                        ...
                        <Col style={{ textAlign: "center" }}>
                            {" "}
                            <h1>{this.state.menu_name_select}</h1>
                        </Col>
                ...
                <CardBody style={{ height: "auto", margin: "20px" }}>
                    ...
                    >
                        ...
                        {this.state.childent_menu_1.map((item, idx) => (
                            ...
                            >
                                ...
                                <Link
                                    ...
                                    onClick={
                                        () => this.props._on_select_menu_2(item.product_menu_name)
                                    }
                                >
                                    <Row>
...
export default Menu_product_level2;
