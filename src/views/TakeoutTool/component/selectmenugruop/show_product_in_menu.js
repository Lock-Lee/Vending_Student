...
import IssueOptionModal from "../selectgruop/modal/main-select-option.modal";
...
export class Show_product_in_menu extends Component {
  constructor(props) {
    super(props);
    this.state = {
      btn_selec: true,
  ...
  async _fetchData() {
    let product_code_menu_name = this.props.product_code_menu_name;

    const products_filter =
      await productmenuList_model.getProductByProductMenuName({
        product_menu_name: product_code_menu_name,
      });
    ...
    this.setState(
      {
        ...
        products_filter: products_filter.data,
        check_list_Articles: false,
        user_code: user_code,
  ...
  _option_display_back = () => {
    const { pre_page } = this.state;
    // console.log("pre_page", pre_page);
    if (pre_page == "page_1") {
      this.props._displayback({
        title: "Menu_product_level2",
      });
    } else if (pre_page == "page_2") {
      this.props._displayback({
        title: "Menu_product_level3",
      });
    } else if (pre_page == "page_3") {
      this.props._displayback({
        title: "Menu_product_level4",
      });
    } else if (pre_page == "page_4") {
      this.props._displayback({
        title: "product_in_menu4",
      });
    }
  };
            ...
            <Row>
              <Col>
                ...
                <Button
                  ...
                  onClick={() => this._option_display_back()}
                >
                  {" "}
...
export default Show_product_in_menu;
