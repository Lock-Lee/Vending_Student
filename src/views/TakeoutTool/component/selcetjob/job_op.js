...
export class Job_op extends Component {
  constructor(props) {
    super(props);
    this.state = {
      loading: true,
    ...
    return (
      <div>
        ...
        <CardBody style={{ backgroundColor: "white", height: "50vh" }}>
          <Row>
            {this.props.job_ops.map((item, idx) => (
              <Row key={"job_ops" + idx}>
                <Col md={1}>
                  <Card
                    color="info"
                    ...
                    onClick={() =>
                      this.props._onSelectOp(item.job_op_code, item.job_op_name)
                    }
                  >
                    <Row>
                    ...
                    <CardBody>
                      <p style={{ height: "50px", color: "white" }}>
                        <CardTitle>
                          <b>{item.job_op_code}</b>
                        </CardTitle>
                        <CardTitle>
                          <b>{item.job_op_name}</b>
                        </CardTitle>
                      </p>
                    </CardBody>
                  </Card>
        ...
        <CardFooter style={{ backgroundColor: "white", height: "20vh" }}>
          <Row>
            ...
            <Button
              ...
              onClick={() => this.props._displayback({ current_display: "" })}
            >
