...
export class Select_job_level3 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      loading: true,
  ...
  _onselct_jobcard(job_name, name_thai, index) {
    this.props._onSelectJobLevel3(job_name, name_thai)
          ...
          <CardBody>
            {this.state.loading ? (
              ...
              <>
                ...
                >
                  {this.props.job_level3.map((item, idx) => (
                    <Row key={"jobs_" + idx}>
                      <Col md={6}>
                        <Card
                          ...
                          onClick={() => this._onselct_jobcard(item.job_level_3_name, {
...
export default Select_job_level3;
