...
export class Select_job_level1 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      loading: true,
          ...
          <CardBody>
            {this.state.loading ? (
              ...
              <>
                ...
                >
                  {this.props.job_level1.map((item, idx) => (
                    <Row key={"jobs_" + idx}>
                      <Col md={6}>
                        <Card
                          ...
                          onClick={() => this._onselct_jobcard(item.job_level_1_name, {
              ...
              <FormGroup>
                {/* {status_show_withdraw
                  ...
                  <>
                    ...
                    // onClick={() =>
                    //   this.props._onSelect_withdraw_now(this.state.job_level_1_name,
                    //     {
                    //       product_unit_thai: product_unit_thai,
                    //       product_issue_type_thai:
                    //         product_issue_type_thai,
                ...
                <Button
                  ...
                  onClick={() =>
                    this.props._displayback({
                      event_page_current: 'select_job_level1',
                    })
                  }
                >
                  <i className="fas fa-undo"></i>
...
export default Select_job_level1;
