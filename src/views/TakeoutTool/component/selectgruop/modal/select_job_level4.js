...
export class Select_job_level4 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      loading: true,
  ...
  _onselct_jobcard(job_name, name_thai, index) {
    this.props._onSelectJobLevel4(job_name, name_thai)
          ...
          <CardBody>
            {this.state.loading ? (
              ...
              <>
                ...
                >
                  {this.props.job_level4.map((item, idx) => (
                    <Row key={"jobs_" + idx}>
                      <Col md={6}>
                        <Card
                          ...
                          onClick={() => this._onselct_jobcard(item.job_level_4_name, {
...
export default Select_job_level4;
