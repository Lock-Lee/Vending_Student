...
export class Select_procress extends Component {
  constructor(props) {
    super(props);
    this.state = {
      loading: true,
          ...
          <CardBody>
            {this.state.loading ? (
              ...
              <>
                ...
                >
                  {this.props.procress.map((item, idx) => (
                    <Row key={"jobs_" + idx}>
                      <Col md={6}>
                        <Card
                          color="info"
                ...
                <Button
                  ...
                  onClick={() =>
                    this.props._displayback({
                      event_page_current: 'event_page_procress',
                    })
                  }
                >
...
export default Select_procress;
