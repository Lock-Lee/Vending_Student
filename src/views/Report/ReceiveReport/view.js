...
class View extends React.Component {
  ...
  _sendEmail() {
    Swal.fire({
      title: "คุณต้องการ ?",
      text: "ส่งรายงานการรับสินค้าไปยังอิเมล !",
      icon: "warning",
      ...
      if (result.isConfirmed) {
        this.setState(
          ...
          async () => {
            const data = await report_model.sendReceiveReport({
  ...
  _fetchData() {
    this.setState(
      ...
      async () => {
        const data = await report_model.getReceiveReport({
          date_start: time_format.dateToStr(this.state.date_start),
          date_end: time_format.dateToStr(this.state.date_end),
        });
